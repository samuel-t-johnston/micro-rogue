// Attribute resolver: the single place that computes an entity's effective stats.
...
// Returns the entity's effective value for `attribute`: base + sum of worn-equipment
// modifiers. For HP this is the effective max; the stored health.current is separate and
// is not clamped here (no item currently grants +HP, so no clamp policy is owed yet).
