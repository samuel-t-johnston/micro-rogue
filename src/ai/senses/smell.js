...
// Smell sense. Like hearing, it reports no entities and no visible tiles — it surfaces *scents* into
// the SenseResult's `smells` channel (merged into context.perception.smells). For each scent profile
// whose intensity at the smeller's tile clears the smeller's threshold, it emits a percept:
//
//   { profile, direction, intensity }   // direction = gradient toward the source, or null at a peak
//
