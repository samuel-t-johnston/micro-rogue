 ...
 * passable, wait (a consumed, no-op turn) rather than forfeiting via a free action — returning a
 * free action here would re-run this goal in the same loop iteration and spin forever for a
 * boxed-in creature.
 */
