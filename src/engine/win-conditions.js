// The win-condition evaluator — the flexible counterpart to death: a registry of named checks that
// each receive the settled game state and decide whether the run has been won. Mirrors the upkeep
// and goal/effect registries so devs can register their own, potentially unconventional, victory
// conditions without touching the turn loop or the game scene.
//
...
// The classic escape victory, as a reusable condition factory: the player wins by standing on a
