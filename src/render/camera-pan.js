/**
 * @file Pure camera math for drag-to-pan. The camera is in tile coordinates (its position is the tile
 * at screen center); a pan converts a screen-pixel drag into a tile-space shift and clamps the result
 * so the level stays mostly on-screen. Kept free of renderer/scene state so it can be unit-tested.
 */
