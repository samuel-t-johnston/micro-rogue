 ...
 * shouting goal builds. The player perceives shouts through the hearing sense, not this emission, so
 * nothing is logged here.
 * @returns {boolean} Always `false` — shouting consumes the turn.
 */
