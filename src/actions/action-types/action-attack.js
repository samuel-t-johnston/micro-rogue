 ...
 * resolver (unarmed base + worn-weapon modifiers); damage is applied through the shared 'damage'
 * effect, which also handles death when HP reaches 0.
 * @returns {boolean} Always `false` — attacking consumes the turn (including a swing at a target
 *   that died before resolution).
 */
