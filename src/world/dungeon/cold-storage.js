// Cold storage: freezing the active level into a serialized blob and thawing it back. This is the
// "model (b)" runtime — only the *active* level's entities ever live in the registry, so the
