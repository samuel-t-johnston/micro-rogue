// Finishing stage: marks where the player arrives. Places an `entryPoint` entity on a room tile in
// the `stairs-up` zone (the classic "arrive on the up-stairs" — it lands on the same centre tile the
// stairs stage uses). The game scene reads it via resolveSpawn. See docs/design/procedural-3x3-dungeon.md.
