// Structure stage: seeded selection from a set of fixed layouts ("static choice"). Picks one of the
// `layouts` via the generation RNG, then loads it exactly like the `static` stage — same tiles +
