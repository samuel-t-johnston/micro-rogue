...
**The evaluator** — [`src/ai/goal-evaluator.js`](../../src/ai/goal-evaluator.js)
Runs the stack top-down each turn; the **first goal to return an action wins** and evaluation stops there. Order *is* priority.

**The context** — [`src/ai/planning-context.js`](../../src/ai/planning-context.js)
