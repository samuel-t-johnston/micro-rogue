...
Diffusion runs once per player turn in the [upkeep registry](../../src/engine/upkeep.js), and the field is **saved** with the level. See the [smell & scent how-to](smell.md) for the full flow and the scuttler example.
