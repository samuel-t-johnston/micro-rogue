...
ROGμE is designed to be an easy way to jump into roguelike development. 
...
There are many good game engines for roguelikes. ROGμE tries to make life easier for developers in a few ways.
